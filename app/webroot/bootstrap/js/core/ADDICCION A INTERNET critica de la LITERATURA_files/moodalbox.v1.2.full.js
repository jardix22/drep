...
var _ERROR_MESSAGE = "Oops.. el raton se callo de la rueda.<br /><br />" +
					"Pro favor intenta de nuevo.<br /><br />" +
					"<em>Da click donde sea para cerrar</em>"; // the error message displayed when the request has a problem
...
var _CONTENTS_WIDTH 		= 300;		// 500Actual width of the box (px)
var _CONTENTS_HEIGHT		= 400;		// 400Actual height of the box (px)
var _DEF_CONTENTS_WIDTH		= 300;		// 500Default width of the box (px) - used for resetting when a different setting was used
