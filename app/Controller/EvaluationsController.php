...
class EvaluationsController extends AppController
{
	public function take($type=null)
	{
		...
		if($this->request->is('get')){
			...
			$this->set('curricularAreas', $this->CurricularArea->find('list', array('conditions' => array('level_id' => 3))) );
	...
	public function takeSecondaryProfessor($type=null)
	{
		$this->loadModel('Test');
		$this->loadModel('CurricularArea');
	...
	public function saveSecondaryProfessor($id=null)
		{
		$this->loadModel('Person');
		$this->loadModel('Worker');
